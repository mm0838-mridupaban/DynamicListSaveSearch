  ...
  function (Controller) {
    ...
    return Controller.extend("frontend.controller.LandingPage", {
      ...
      onClickCreate:async function(){
        ...
        let localUrl=this.getOwnerComponent().getModel("mainModel").getServiceUrl();
      ...
      this.createColumnSettings(localUrl,table_id,lastIdNumber,columnNames)
      ...
      creatingTableList: async function (newTable) {
        // let oModel = this.getView().getModel("tableDataModel");
        // let newTable = oModel.getProperty("/NewTable");
        // let entity = newTable.entitySelected;
        // let table_id = newTable.table_id;
      ...
      getLastColumnId:function(){
        ...
        $.ajax({
          ...
          success: function (data) {
              ...
              //     let column_id = "some_unique_id_for_column_" + (lastIdNumber + index + 1); // Generate column_id based on the last ID
              ...
              //     newColumnSettings.push(newColumnSetting);
              }
      ...
      createColumnSettings:function(localUrl,tableId,lastIdNumber, columnNames) {
